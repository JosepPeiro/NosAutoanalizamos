...
```{r}
datos = read_tsv("./data/NosAutoanalizamos2021 - Hoja1.tsv", skip=25) %>% select(-1)
glimpse(datos)
```
...
```
Los pares que mas correlacion tienen son Fundamentos de la Programacion con Matematica Discreta
